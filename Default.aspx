...
<a href="#"><img src="data1/images/8.jpg" alt="" title="" id="wows4"/></a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="log">ONLINE CLASSROOM</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;">AMVSoftware2023 </div>
    </form>
</body>
</html>
